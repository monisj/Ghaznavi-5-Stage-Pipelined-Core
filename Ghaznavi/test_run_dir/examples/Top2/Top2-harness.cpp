...
#endif
#include <iostream>
class Top2_api_t: public sim_api_t<VerilatorDataWrapper*> {
    public:
    Top2_api_t(VTop2* _dut) {
        dut = _dut;
        main_time = 0L;
        is_exit = false;
#if VM_TRACE
    ...
    void init_sim_data() {
        ...
        sim_data.signal_map["Top2.reset"] = 0;
    }
#if VM_TRACE
...
int main(int argc, char **argv, char **env) {
    ...
    VTop2* top = new VTop2;
    std::string vcdfile = "test_run_dir/examples/Top2/Top2.vcd";
